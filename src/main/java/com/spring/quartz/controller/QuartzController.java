...
public class QuartzController {
    ...
    @PatchMapping(path = "/groups/{group}/jobs/{name}/trigger")
    public ResponseEntity<Void> triggerJob(@PathVariable String group, @PathVariable String name) {
        quartzService.triggerJob(group, name);
        return ResponseEntity.noContent().build();
    }
}
