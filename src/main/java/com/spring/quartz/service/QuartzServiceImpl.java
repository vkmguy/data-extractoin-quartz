...
public class QuartzServiceImpl implements QuartzService {
    ...
    public JobDescriptor createJob(String group, JobDescriptor descriptor) {
        ...
        JobDetail jobDetail = descriptor.buildDailyMarketJobDetail();
    ...
    public void triggerJob(String group, String name) {
        try {
            ...
            log.info("Triggered job with key - {}.{}", group, name);
        } catch (SchedulerException e) {
            log.error("Could not trigger job with key - {}.{} due to error - {}", group, name, e.getLocalizedMessage());
        }
    }
}
